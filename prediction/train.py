...
"""Training entry point for the HiVT prediction module.

This script mirrors the top-level ``train.py`` but imports the model
through the ``prediction`` package, making it the canonical way to
train HiVT when it is used as a drop-in prediction module.
...
def main() -> None:
    ...
    model_checkpoint = ModelCheckpoint(
        monitor=args.monitor, save_top_k=args.save_top_k, mode='min')
